...
export const workData = [
    ...
    },
    {
        ...
        description: '(Data Analysis)',
        bgImage: '/work-4.png',
        link: 'https://github.com/EEscat1804/Spotify-Data-Extraction',
    },
]
...
export const infoList = [
    { icon: assets.code_icon, iconDark: assets.code_icon_dark, title: 'Languages', description: 'Python, Java, C/C++, SQL, HTML, CSS, JavaScript React Js, Next Js' },
    { icon: assets.edu_icon, iconDark: assets.edu_icon_dark, title: 'Education', description: 'University of California Berkeley, Bachelor of Science in Electrical Engineering and Computer Science'},
    { icon: assets.project_icon, iconDark: assets.project_icon_dark, title: 'Projects', description: 'Built multiple projects covering a wide range of concepts such as data extraction, full-stack web development, and machine learning.' }
];
