          ...
          className='flex w-full justify-items-center justify-center flex-col lg:flex-row items-start gap-16 my-10'>
            ...
            className='flex-1 justify-center'>
              ...
              >
               ...
               break out of my shell and develop key communication skills. Currently I am a member of PASAE as a transfer rep intern, where 
               I help represent transfer STEM students and assist in providing resources to help transfers find their place in Berkeley. 
