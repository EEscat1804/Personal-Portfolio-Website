  ...
  return (
    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%] dark:hidden'>
        ...
        <nav className={`w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50 ${isScroll ? 
            ...
            <ul className={`hidden md:flex items-center gap-8 lg:gap-8 rounded-full 
            ...
            <div className='flex items-center'> 
                ...
                <a href="#contact" className='hidden lg:flex items-center gap-2 px-2.5
                py-2 border border-gray-500 rounded-full ml-4 font-Ovo dark:border-white/50'>Contact 
            ...
            duration-500 dark:bg-gray-800 dark:text-white'>
